...
CREATE TABLE `t_sys_permission` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_tc4iladis69qv0ju7i3ui20jq` (`resource_id`),
  CONSTRAINT `FK_tc4iladis69qv0ju7i3ui20jq` FOREIGN KEY (`resource_id`) REFERENCES `t_sys_resource` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=134 DEFAULT CHARSET=utf8;

/*Data for the table `t_sys_permission` */

insert  into `t_sys_permission`(`id`,`code`,`resource_id`,`description`,`create_time`) values (5,'user:add',2,'新增用户','2015-01-27 00:28:19'),(6,'user:modify',2,'修改用户','2015-01-27 00:28:44'),(7,'user:delete',2,'删除用户','2015-01-27 00:29:00'),(8,'user:enable',2,'启用用户','2015-01-27 00:30:18'),(9,'resource:add',3,'新增菜单','2015-01-27 00:30:43'),(10,'resource:modify',3,'修改菜单','2015-01-27 00:31:02'),(11,'resource:delete',3,'删除菜单','2015-01-27 00:31:20'),(12,'role:add',4,'新增角色','2015-01-27 00:32:01'),(13,'role:modify',4,'编辑角色信息','2015-01-27 00:32:19'),(14,'role:delete',4,'删除角色','2015-01-27 00:32:37'),(15,'role:permission_setup',4,'设置权限','2015-01-27 00:34:48'),(16,'permission:add',5,'新增权限','2015-01-27 00:35:34'),(17,'permission:delete',5,'删除权限','2015-01-27 00:35:53'),(18,'user:view',2,'查看用户信息','2015-01-27 00:36:21'),(19,'resource:view',3,'查看菜单','2015-01-27 00:36:43'),(20,'role:view',4,'查看角色信息','2015-01-27 00:37:00'),(21,'permission:view',5,'查看权限','2015-01-27 00:37:19'),(22,'advertiser:view',6,'查看广告主','2015-01-27 17:45:55'),(23,'advertiser:add',6,'添加广告主','2015-01-27 18:30:28'),(24,'developer:view',6,'开发者查看账户信息','2015-01-29 19:59:52'),(25,'developer:add',6,'添加账户','2015-01-29 20:00:36'),(26,'adpackage:view',6,'查看广告包','2015-01-30 17:01:57'),(27,'advertiser:modify',6,'修改广告主','2015-02-02 23:25:18'),(28,'developer:modify',6,'修改开发者信息账户','2015-02-03 00:41:04'),(29,'developer:freeze',6,'冻结开发者账户','2015-02-03 00:42:09'),(30,'developer:normal',6,'解冻开发者账户','2015-02-03 00:42:58'),(31,'developer:disable',6,'封存开发者账户','2015-02-03 03:36:24'),(32,'adpackage:add',6,'添加广告包','2015-02-03 18:19:32'),(33,'developer:savePayment',6,'保存付款方式','2015-02-03 22:41:28'),(34,'application:view',6,'查看媒体应用','2015-02-04 01:53:38'),(35,'application:add',6,'添加应用','2015-02-04 19:13:47'),(36,'application:modify',6,'修改应用','2015-02-04 19:14:46'),(37,'adpackage:modify',6,'修改广告包','2015-02-04 23:15:47'),(38,'adpackage:delete',6,'删除广告包','2015-02-05 01:08:13'),(39,'adplacement:view',6,'查看投放','2015-02-05 10:38:32'),(40,'adplacement:modify',6,'修改投放','2015-02-06 10:03:10'),(41,'application:freeze',6,'冻结开发者应用','2015-02-07 00:19:00'),(42,'application:normal',6,'解冻开发者应用','2015-02-07 00:19:20'),(43,'application:disable',6,'封闭开发者应用','2015-02-07 00:20:09'),(44,'application:pause',6,'暂停开发者应用','2015-02-07 00:20:56'),(45,'channel:view',6,'查看媒体渠道信息','2015-02-09 10:07:54'),(46,'channel:add',6,'添加媒体渠道','2015-02-09 10:08:21'),(47,'channel:modify',6,'修改媒体渠道','2015-02-09 10:09:22'),(48,'appPackage:add',6,'上传应用包','2015-02-11 22:21:47'),(49,'appPackage:view',6,'查看应用包','2015-02-11 22:22:10'),(50,'appPackage:modify',6,'修改应用包','2015-02-11 22:22:40'),(51,'appPackage:download',6,'下载应用包','2015-02-11 22:23:19'),(52,'application:check',6,'应用审核','2015-02-12 00:42:06'),(53,'application:grade',6,'管理应用等级','2015-02-12 23:12:54'),(54,'application:rate',6,'管理媒体应用配比','2015-02-12 23:13:36'),(55,'ad:view',6,'查看广告','2015-02-12 15:21:36'),(56,'fee:view',6,'查看费用记录','2015-02-13 14:03:39'),(58,'financeDev:view',6,'查看媒体账户信息','2015-03-02 11:30:16'),(59,'financeDev:add',6,'新增开发者账户','2015-03-02 14:04:02'),(60,'financeDetail:view',6,'查看媒体收入明细','2015-03-02 20:05:43'),(61,'notice:view',6,'查看新闻公告','2015-03-03 04:31:40'),(62,'notice:add',6,'增加新闻公告','2015-03-03 04:32:07'),(63,'notice:modify',6,'修改新闻公告','2015-03-03 04:32:32'),(64,'mail:view',6,'查看邮件列表','2015-03-03 04:33:08'),(65,'mail:add',6,'增加邮件','2015-03-03 04:33:33'),(66,'mail:modify',6,'修改邮件','2015-03-03 04:33:56'),(67,'financeDev:modify',6,'编辑开发者账户信息','2015-03-04 11:41:36'),(68,'notice:delete',6,'删除公告','2015-03-14 03:33:22'),(69,'financeApply:view',6,'查看媒体提现申请','2015-03-04 15:48:32'),(70,'applyMoney:modifyPayType',6,'修改媒体支付类型','2015-03-04 17:46:43'),(71,'applyMoney:modifyStatus',6,'修改媒体支付状态','2015-03-04 18:29:54'),(72,'applyMoney:modifyStatusPay',6,'媒体提现确定支付','2015-03-05 10:25:30'),(73,'applyMoney:modifyStatusNotPay',6,'媒体提现拒绝支付','2015-03-05 12:22:17'),(74,'financeDev:modifyStatusPass',6,'媒体账户审核通过','2015-03-05 14:50:01'),(75,'financeDev:modifyStatusNotPass',6,'媒体账户管理审核未通过','2015-03-05 14:50:42'),(76,'applyMoney:modifyinvoiceStatus',6,'修改发票状态','2015-03-05 17:07:57'),(77,'financeAd:view',6,'查看广告主消耗明细','2015-03-09 11:56:42'),(78,'financeAdBalance:view',6,'查看广告主财务记录','2015-03-09 14:25:26'),(79,'financeAdBalance:sureCharge',6,'广告主财务记录确认收款','2015-03-09 15:59:36'),(80,'adbyhour:view',6,'查看广告按小时统计','2015-03-10 20:14:38'),(81,'adbyday:view',6,'查看广告按天统计','2015-03-10 20:19:57'),(82,'appbyhour:view',6,'查看媒体按小时统计','2015-03-10 20:20:44'),(83,'appbyday:view',6,'查看媒体按天统计','2015-03-10 20:21:19'),(84,'totalbyday:view',6,'查看综合按天统计','2015-03-10 20:22:02'),(85,'totalbyhour:view',6,'查看综合按小时统计','2015-03-10 20:22:32'),(86,'devAndroidIncome:modify',6,'运营管理安卓开发者确认或者不确认','2015-03-10 19:34:33'),(87,'devIosIncome:modify',6,'运营管理IOS开发者确认或者不确认','2015-03-10 19:53:17'),(88,'adAndroidConfirm:modify',6,'广告主消耗确认','2015-03-11 14:27:35'),(89,'applyMoney:modifyCheck',6,'媒体提现申请审核是否通过按钮','2015-03-11 16:48:58'),(90,'dockingAdver:view',6,'查看广告对接参数设置','2015-03-24 23:04:23'),(91,'dockingAdver:add',6,'增加广告主对接参数','2015-03-24 23:04:54'),(92,'dockingAdver:modify',6,'修改广告主对接参数','2015-03-24 23:06:08'),(93,'deverActivate:view',6,'查看IOS激活列表','2015-03-25 10:42:29'),(94,'deverActivate:send',6,'再次发送激活','2015-03-25 10:43:46'),(95,'advertiser:loadExcel',6,'广告主导出Excel','2015-03-27 11:52:29'),(96,'package:loadExcel',6,'广告包导出Excel','2015-03-27 11:55:53'),(97,'placement:loadExcel',6,'投放管理导出Excel','2015-03-27 11:56:40'),(98,'ad:loadExcel',6,'广告管理导出Excel','2015-03-27 11:57:46'),(99,'adoffline:loadExcel',6,'广告下线导出Excel','2015-03-27 11:58:38'),(100,'adFee:loadExcel',6,'广告费用记录导出Excel','2015-03-27 11:59:30'),(101,'adAndroidConfirm:loadExcel',6,'安卓广告主消耗确认导出Excel','2015-03-27 12:09:41'),(102,'adIosConfirm:loadExcel',6,'IOS广告主消耗确认导出Excel','2015-03-27 12:10:30'),(103,'adBalance:loadExcel',6,'广告主结算导出Excel','2015-03-27 12:11:26'),(104,'devAndroidIncome:loadExcel',6,'安卓开发者收入确认导出Excel','2015-03-27 12:12:25'),(105,'devIosIncome:loadExcel',6,'IOS开发者收入确认导出Excel','2015-03-27 12:12:55'),(106,'applyMoney:loadExcel',6,'媒体提现导出Excel','2015-03-27 12:13:40'),(107,'financeAd:loadExcel',6,'广告主消耗明细导出Excel','2015-03-27 12:24:07'),(108,'financeAdBalance:loadExcel',6,'广告主财务记录导出Excel','2015-03-27 12:25:06'),(109,'adInvoice:loadExcel',6,'广告主发票管理导出Excel','2015-03-27 12:26:04'),(110,'financeDev:loadExcel',6,'媒体账户管理导出Excel','2015-03-27 12:30:01'),(111,'financeDetail:loadExcel',6,'媒体收入明细导出Excel','2015-03-27 12:31:07'),(112,'financeApply:loadExcel',6,'媒体付款记录导出Excel','2015-03-27 12:33:49'),(113,'financeDevInvoice:loadExcel',6,'媒体发票管理导出Excel','2015-03-27 14:08:23'),(114,'sspAndroidConfirm:loadExcel',6,'SSP 安卓广告平台消耗确认导出Excel','2015-04-02 14:26:45'),(115,'sspAndroidConfirm:modify',6,'确认','2015-04-02 14:30:52'),(116,'sspBalance:loadExcel',6,'SSP 广告平台结算导出Excel','2015-04-02 14:31:46'),(117,'sspApplyMoney:modifyCheck',6,'SSP 广告平台结算审核','2015-04-02 14:32:15'),(118,'sspConfirm:loadExcel',6,'SSP 平台消耗明细导出Excel','2015-04-02 14:34:38'),(119,'financeSspBalance:loadExcel',6,'SSP 平台财务记录导出Excel','2015-04-02 14:35:56'),(120,'financeSspBalance:sureCharge',6,'SSP 平台财务记录确认收款','2015-04-02 14:36:31'),(121,'sspInvoice:loadExcel',6,'SSP 平台发票管理导出Excel','2015-04-02 14:37:33'),(122,'sspManage:view',6,'展示SSP 广告平台管理页面','2015-04-02 14:52:56'),(123,'sspManage:add',6,'增加SSP 广告平台','2015-04-02 14:58:15'),(124,'sspManage:modify',6,'修改SSP 广告平台','2015-04-02 14:59:00'),(125,'sspManage:delete',6,'删除SSP广告平台','2015-04-02 14:59:30'),(126,'sspRatioManage:view',6,'展示SSP分成比例管理页面','2015-04-02 15:00:35'),(127,'sspRatioManage:modify',6,'修改SSP分成比例','2015-04-02 15:01:06'),(128,'sspRatio:view',6,'展示IosBanner比例设置','2015-04-02 15:01:50'),(129,'sspRatio:add',6,'增加IosBanner比例配置','2015-04-02 15:03:37'),(130,'sspRatio:modify',6,'修改IosBanner比例配置','2015-04-02 15:03:59'),(131,'sspRatio:delete',6,'删除IosBanner比例配置','2015-04-02 15:04:19'),(132,'sspIosConfirm:modify',6,'确认','2015-04-14 15:19:20'),(133,'sspIosConfirm:loadExcel',6,'导出表格','2015-04-14 15:20:39');
...
insert  into `t_sys_role`(`id`,`name`,`description`,`create_time`,`isChecked`) values (1,'管理员','管理员','2015-01-23 12:04:48',NULL),(11,'test1','test1','2015-01-27 12:27:37',NULL),(12,'开发者销售负责人','开发者销售负责人','2015-01-29 15:45:14',NULL),(13,'test','测试','2015-03-12 14:38:57',NULL),(14,'销售000','销售000','2015-04-27 16:29:36',NULL),(15,'管理员111','管理员111','2015-04-27 16:33:42',NULL);
...
CREATE TABLE `t_sys_role_perminssion_rel` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_sobrnjl2lg1y8fj7t21a33s7r` (`permission_id`),
  KEY `FK_lgeixauql2qv752aqlqj4umns` (`role_id`),
  CONSTRAINT `FK_lgeixauql2qv752aqlqj4umns` FOREIGN KEY (`role_id`) REFERENCES `t_sys_role` (`id`),
  CONSTRAINT `FK_sobrnjl2lg1y8fj7t21a33s7r` FOREIGN KEY (`permission_id`) REFERENCES `t_sys_permission` (`id`)
...
CREATE TABLE `t_sys_role_resource_rel` (
  ...
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`),
  KEY `FK_fdnc6rp0jy4div7guk1aagumo` (`role_id`),
  CONSTRAINT `FK_fdnc6rp0jy4div7guk1aagumo` FOREIGN KEY (`role_id`) REFERENCES `t_sys_role` (`id`)
...
CREATE TABLE `tao_order` (
  ...
  `MemberEntity` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_if01e9331xwf42lngm2nq8cj1` (`MemberEntity`),
  KEY `FK_rut51bofcfxl82e4paeity7yg` (`member`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

/*Data for the table `tao_order` */

insert  into `tao_order`(`id`,`create_date`,`modify_date`,`address`,`amount_paid`,`area_name`,`consignee`,`coupon_discount`,`expire`,`fee`,`freight`,`invoice_title`,`is_allocated_stock`,`is_invoice`,`lock_expire`,`memo`,`offset_amount`,`order_status`,`payment_method_name`,`payment_status`,`phone`,`point`,`promotion`,`promotion_discount`,`shipping_method_name`,`shipping_status`,`sn`,`tax`,`zip_code`,`area`,`coupon_code`,`member`,`operator`,`payment_method`,`shipping_method`,`MemberEntity`) values (3,'2015-05-23 16:54:49','2015-05-25 16:30:00','fdfd','0','北京市西城区','akaa','0','2015-05-24 16:54:49','0','0',NULL,'\0','\0','2015-05-23 17:10:10',NULL,'0',0,'网上支付',0,'12121212121',2320,NULL,'0','普通快递',0,'20150523103','0','12121',3,NULL,2,1,1,1,NULL),(4,'2015-05-23 16:56:26','2015-05-23 17:12:05','fdfd','1804','北京市西城区','akaa','0',NULL,'0','10',NULL,'\0','\0','2015-05-23 17:12:25',NULL,'0',2,'货到付款',2,'12121212121',1794,NULL,'0','顺丰速递',2,'20150523104','0','12121',3,NULL,2,1,3,2,NULL),(5,'2015-05-23 17:12:12','2015-05-23 17:26:22','fdfd','500','北京市西城区','akaa','0',NULL,'0','10',NULL,'\0','\0','2015-05-23 17:26:42',NULL,'0',1,'货到付款',1,'12121212121',568,NULL,'0','顺丰速递',2,'20150523105','0','12121',3,NULL,2,1,3,2,NULL),(6,'2016-07-27 21:47:11','2016-07-27 21:47:11','我的订单地址',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,2,NULL,NULL,NULL,NULL);
