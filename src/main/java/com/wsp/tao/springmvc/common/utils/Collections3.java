...
import com.wsp.tao.springmvc.common.utils.Reflections;
 ...
 *@Description:在JDK的Collections和Guava的Collections2后, 命名为Collections3，函数主要由两部分组成，
 *		一是自反射提取元素的功能，二是源自Apache Commons Collection, 争取不用在项目里引入它。
 *@Author:wangdezhen#zplay.cn
 *@Since:2015年1月20日  上午10:20:42
 *@Version:1.0
 */
