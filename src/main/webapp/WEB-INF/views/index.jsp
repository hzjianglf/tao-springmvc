...
<head>
    ...
    <LINK rel="Bookmark" href="${base}/sources//favicon.ico" >
    <LINK rel="Shortcut Icon" href="${base}/sources//favicon.ico" />
    <!--[if lt IE 9]>
    <script type="text/javascript" src="sources/lib/html5.js"></script>
    <script type="text/javascript" src="sources/lib/respond.min.js"></script>
    <script type="text/javascript" src="sources/lib/PIE_IE678.js"></script>
    <![endif]-->
    <link rel="stylesheet" type="text/css" href="${base}/sources/static/h-ui/css/H-ui.min.css" />
    <link rel="stylesheet" type="text/css" href="${base}/sources/static/h-ui.admin/css/H-ui.admin.css" />
    <link rel="stylesheet" type="text/css" href="${base}/sources/lib/Hui-iconfont/1.0.7/iconfont.css" />
    <link rel="stylesheet" type="text/css" href="${base}/sources/lib/icheck/icheck.css" />
    <link rel="stylesheet" type="text/css" href="${base}/sources/static/h-ui.admin/skin/default/skin.css" id="skin" />
    <link rel="stylesheet" type="text/css" href="${base}/sources/static/h-ui.admin/css/style.css" />
    <!--[if IE 6]>
...
<script type="text/javascript" src="${base}/sources/lib/jquery/1.9.1/jquery.min.js"></script>
<script type="text/javascript" src="${base}/sources/lib/layer/2.1/layer.js"></script>
<script type="text/javascript" src="${base}/sources/static/h-ui/js/H-ui.js"></script>
<script type="text/javascript" src="${base}/sources/static/h-ui.admin/js/H-ui.admin.js"></script>
